...
class CustodiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create custodian" do
    assert_difference('Custodian.count') do
      post custodians_url, params: { custodian: { name: @custodian.name, specialty: @custodian.specialty } }
    end
  ...
  test "should update custodian" do
    patch custodian_url(@custodian), params: { custodian: { name: @custodian.name, specialty: @custodian.specialty } }
