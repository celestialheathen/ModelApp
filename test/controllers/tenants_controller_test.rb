...
class TenantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tenant" do
    assert_difference('Tenant.count') do
      post tenants_url, params: { tenant: { name: @tenant.name, rent: @tenant.rent, term: @tenant.term } }
    end
  ...
  test "should update tenant" do
    patch tenant_url(@tenant), params: { tenant: { name: @tenant.name, rent: @tenant.rent, term: @tenant.term } }
